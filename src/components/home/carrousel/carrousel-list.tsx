      ...
      <CarrouselCard
        ...
        description={
          <>
            ...
            Obtén hasta un <strong>10% de descuento en tu primera compra</strong>
          </>
        }
      ...
      <CarrouselCard
        ...
        description={
          <>
            ...
            <br />
            No dudes en preguntarnos por <strong>la calidad de tu producto</strong>
          </>
        }
        textButton="Contactarnos"
        title="Calidad"
      >
        <Image src={"/new-balance-2.png"} alt="New Balance" width={400} height={400} />
      </CarrouselCard>
    </CarouselContent>
  )
}
